...
| 7 | #408 | 대량 전환 1차 (11종 일괄) | 1 | ✅ | 없음 | auth-blocked·params(배치) | 변환기+배치녹화 기계화. 403 활용신청 94·400 파라미터 141은 백로그 #409 |

## 집계 (업데이트: 2026-09-09, 1차 라운드 종료)
- 구현 시도 2건 / 통과 2건 / 무수정 merge 2건 + 대량 전환 11종 → **통과율 100% (n=13 데이터셋)**
