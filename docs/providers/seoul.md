...
|----------|-------------|--------|
| 따릉이 월별 이용정보 (`bike_rent_month`) | [kpubdata/seoul-bike-rent-month](https://huggingface.co/datasets/kpubdata/seoul-bike-rent-month) | [yschoe/seoul-bike-rent-month](https://www.kaggle.com/datasets/yschoe/seoul-bike-rent-month) |
...
api.upload_file(
    ...
    repo_id="kpubdata/seoul-bike-rent-month",
    repo_type="dataset",
)
