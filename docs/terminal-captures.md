...
![Python으로 데이터 조회](assets/terminal/python_usage.gif)
...
![오류 처리 예시](assets/terminal/error_handling.gif)
...
![CLI 데이터셋 목록](assets/terminal/cli_datasets.gif)
...
![make verify 실행 결과](assets/terminal/make_verify.gif)
...
![Replay 모드 실행](assets/terminal/replay_mode.gif)
