...
| 지원 | 테스트 검증 | - | 한국은행 ECOS (`bok`) | `money_supply` | 통화량(M2) | [ECOS](https://ecos.bok.or.kr/api/) 인증키 | [ecos.bok.or.kr](https://ecos.bok.or.kr/api/) | ECOS 통계표 `101Y003`, 항목코드 `BBHS00`, 월별 데이터, [#229](https://github.com/yeongseon/kpubdata/issues/229) |
