...
| 지원 | 실API 검증 | 2026-04-26 | 공공데이터포털 (`datago`) | `g2b_contract` | 나라장터 조달계약정보 | [공공데이터포털](https://www.data.go.kr) 서비스키 | [data.go.kr](https://www.data.go.kr) | 조달청 제공 (HrcspSsstmtInfoService), [#188](https://github.com/yeongseon/kpubdata/issues/188) |
| 지원 | 실API 검증 | 2026-04-26 | 공공데이터포털 (`datago`) | `social_enterprise` | 사회적기업 인증현황 | [공공데이터포털](https://www.data.go.kr) 서비스키 | [data.go.kr](https://www.data.go.kr) | 고용노동부 제공 (SocentInfoService), [#189](https://github.com/yeongseon/kpubdata/issues/189) |
| 지원 | 실API 검증 | 2026-04-26 | 공공데이터포털 (`datago`) | `coop` | 협동조합 설립현황 | [공공데이터포털](https://www.data.go.kr) 서비스키 | [data.go.kr](https://www.data.go.kr) | 기획재정부 제공 (CoopInfoService), [#190](https://github.com/yeongseon/kpubdata/issues/190) |
| 지원 | 실API 검증 | 2026-04-26 | 공공데이터포털 (`datago`) | `g2b_catalog` | 나라장터 종합쇼핑몰 품목정보 | [공공데이터포털](https://www.data.go.kr) 서비스키 | [data.go.kr](https://www.data.go.kr) | 조달청 제공 (PrdctIdntInfoService), [#191](https://github.com/yeongseon/kpubdata/issues/191) |
