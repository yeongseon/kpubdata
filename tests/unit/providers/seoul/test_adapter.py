...
from kpubdata.providers.seoul import SeoulAdapter
from kpubdata.providers.seoul.adapter import SeoulAdapter as SeoulAdapterFromModule


def test_import_from_package_init_exports_adapter() -> None:
    assert SeoulAdapter is SeoulAdapterFromModule


def test_name_property() -> None:
    adapter = SeoulAdapter()

    assert adapter.name == "seoul"
