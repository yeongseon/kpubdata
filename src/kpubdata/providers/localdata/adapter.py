...
class LocaldataAdapter:
    ...
    def _require_api_key(self) -> str:
        ...
        """
        # 자기 이름을 먼저 본다. localdata 는 data.go.kr 서비스라 datago 와 같은 키를
        # 쓰지만, 곧바로 "datago" 를 요구하면 README 가 안내하는
        # KPUBDATA_LOCALDATA_API_KEY 가 조용히 무시된다.
        return self._config.require_provider_key("localdata", fallback_to="datago")
