...
"""localdata.general_restaurant 예제 — 자동 생성(배치 전환).
...
def main() -> None:
    """localdata.general_restaurant 기본 조회를 실행한다."""
    ...
    print(f"localdata.general_restaurant: {len(batch.items)}건 / 전체 {batch.total_count}건")
