...
"""localdata.rest_cafe 예제 — 자동 생성(배치 전환).
...
def main() -> None:
    ...
    print(f"localdata.rest_cafe: {len(batch.items)}건 / 전체 {batch.total_count}건")
