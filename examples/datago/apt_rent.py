...
"""datago.apt_rent 예제 — 자동 생성(배치 전환).
...
def main() -> None:
    ...
    print(f"datago.apt_rent: {len(batch.items)}건 / 전체 {batch.total_count}건")
